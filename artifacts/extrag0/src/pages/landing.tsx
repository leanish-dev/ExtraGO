    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-1 relative z-10">
        ...
        <div className="relative overflow-hidden" style={{ padding: "clamp(40px,7vw,88px) 0" }}>
          ...
          {/* Content surface — subtle light bloom creates legible area without obscuring art */}
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 82% 68% at 50% 50%, rgba(255,255,255,0.025) 0%, transparent 70%)" }} />
        ...
        <div className="relative overflow-hidden" style={{ padding: "clamp(28px,4.5vw,56px) 20px" }}>
          ...
          {/* Content surface — subtle light bloom defines text zone without layering darkness */}
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 88% 80% at 50% 50%, rgba(255,255,255,0.022) 0%, transparent 68%)" }} />
