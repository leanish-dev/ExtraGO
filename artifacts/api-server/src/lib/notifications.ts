...
const TYPE_CLASSIFICATION: Record<string, { category: NotificationCategory; priority: NotificationPriority }> = {
  ...
  checkin_completed: { category: "applications", priority: "normal" },
  checkout_completed: { category: "applications", priority: "high" },
  job_started: { category: "applications", priority: "normal" },
  application_accepted: { category: "applications", priority: "high" },
  documents_uploaded: { category: "verification", priority: "normal" },
  wallet_reserved: { category: "payments", priority: "low" },
